...
public class WordItemListUtils implements Callable<List<ItemDataProvider>> {
    private final static String logTAG = "WordItemListUtils";
    ...
    public List<ItemDataProvider> call() throws Exception {
        ...
        for (Word word : wordsFromDB) {
            ItemDataProvider itemDataProvider = new WordProvider(fromCurrentPosition + dataList.size(), word);
    ...
    public static void createItemWord(WordProvider word) {
